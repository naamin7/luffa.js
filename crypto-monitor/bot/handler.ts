...
async function askClaude(prompt: string): Promise<string> {
  const apiKey = process.env.CLAUDE_API_KEY=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;
  if (!apiKey) {
...
export function registerHandlers() {
  luffaClient.onMessage(async (msg) => {
