...
const EthersNetwork = {
    ...
    [exports.Network.HYPERLIQUID_TESTNET]: 'hyperliquid-testnet',
    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-13ec895f.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-c6ac4c7e.js'); });
...
function isRetryableHttpError(err, apiType) {
    ...
    const retryableCodes = apiType === AlchemyApiType.WEBHOOK ? [429, 500, 503] : [429, 503];
...
//# sourceMappingURL=index-e0ad43ed.js.map
