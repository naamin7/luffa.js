...
async function askClaude(prompt: string): Promise<string> {
  const response = await anthropic.messages.create({
    ...
    system:
      "You are InvesTrack, an AI crypto portfolio assistant. Help users track their Ethereum tokens. Keep responses short and direct. Ask the user to connect their wallet if possible.",
